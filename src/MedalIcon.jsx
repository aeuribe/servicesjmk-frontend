...
const MedalIcon = () => (
  <svg 
    ...
    style={{ 
      display: 'block', // Evitar cualquier espacio debajo del SVG
      margin: 0, 
      padding: 0, 
      transform: 'translateY(0)', // Alinea perfectamente
      verticalAlign: 'top', // Eliminar el espacio extra por defecto
    }}
  >
    <g>
      <polygon 
